...
export class TweetPromptBuilder {
  buildSystemPrompt(params: PromptParams): string {
    ...
    lines.push(
      ...
      '- Maximum 350 characters. Aim for 200-300 characters for best engagement.',
      '- Be FACTUALLY ACCURATE. Only state what is directly supported by the event details provided.',
      '- Do NOT speculate, invent statistics, or add unverified claims.',
      '- Always write in COMPLETE SENTENCES. No sentence fragments or dangling thoughts.',
      ...
      '- Add your own insight, opinion, or angle while staying factually grounded.',
  ...
  buildBatchSystemPrompt(params: Omit<PromptParams, 'eventTitle' | 'eventDescription'>): string {
    ...
    lines.push(
      '',
      'RULES:',
      '- Maximum 350 characters per tweet. Aim for 200-300 characters for best engagement.',
      '- Be FACTUALLY ACCURATE. Only state what is directly supported by the event details provided.',
      '- Do NOT speculate, invent statistics, or add unverified claims.',
      '- Always write in COMPLETE SENTENCES. No sentence fragments or dangling thoughts.',
      '- Do NOT include hashtags unless one is highly relevant.',
      ...
      '- Do NOT use quotation marks around the tweet.',
      '- Be original—never copy the event headline verbatim.',
      '- Add your own insight, opinion, or angle to each tweet while staying factually grounded.',
